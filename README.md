...
This repository contains the package which provides environment checking service.
...
In order to install and use the linked dependencies for `pkg-env` the following command can be used:
